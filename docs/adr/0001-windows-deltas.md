...
Remove destination-indicator DOM/styles/timers/APIs, picker/settings model, `indicator.picker`, default `I`, and native read/commit indicator commands. The current Windows registry has **51 actions:47 configurable and four fixed**. Preserve search highlights and focus rings. Retired indicator source/tests are archived at `dedcff8513e034efb904ef7d50fd59cc11444798` for redevelopment alongside link hints. No dormant feature flags or aliases.
