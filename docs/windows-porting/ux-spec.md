...
- Inactive tab hover brightens the shared title/close surface without selecting it. The selected tab remains surface-neutral but uses a subtle border and heavier title/close weight; its close control gains further emphasis only on hover or keyboard focus.
