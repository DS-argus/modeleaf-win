...
Issue #53 owner delta: TOC·keyboard hint·destination indicator 원본은 재개발 reference이며 현재 Windows runtime 요구가 아니다. 일반 링크 클릭은 유지하고 pane7/TOC3/hint1/indicator1 action을 제외하여 Windows51 actions(45 configurable+4 fixed)를 사용한다. 퇴역 indicator는 dedcff85, TOC/hints는7e00424에 보존하며 `deferred-toc-link-hints.md`를 따른다.
