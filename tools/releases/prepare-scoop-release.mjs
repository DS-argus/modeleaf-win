...
function buildReleaseNotes({ repository, tag, version }) {
  ...
  return [
    ...
    "",
    "This is the initial experimental Modeleaf release for Windows 11 x64. The owner accepted basic app use for this initial release. Remaining native behavior, DPI scaling, Narrator accessibility, clean-machine installation, and Authenticode signature checks are unverified.",
    "",
    "Known limitations:",
    "- Live configuration changes are not yet applied completely.",
    "- Full-document printing is incomplete.",
    "- Update retrieval is incomplete.",
    "- Embedded table of contents (TOC), keyboard link hints, and link-destination indicators are not included; they were retired from this build.",
    "",
    "Prerequisite: Install the Microsoft Edge WebView2 Runtime before launching Modeleaf.",
    "",
    "Install this exact version with Scoop using the supported versioned release manifest:",
    "",
    "```powershell",
    `scoop install ${manifestUrl}`,
    "```",
    "",
    "This direct versioned manifest does not create or imply an automatic Scoop bucket or update channel.",
    "",
  ].join("\n");
}
