...
export type RecentOpenOutcome =
  ...
  | { readonly tag: "ACCESS_DENIED"; readonly reason: "PATH_REJECTED" | "PERMISSION_DENIED" }
...
const RECENT_FAILURE_REASONS = {
  ...
  ACCESS_DENIED: new Set(["PATH_REJECTED", "PERMISSION_DENIED"]),
